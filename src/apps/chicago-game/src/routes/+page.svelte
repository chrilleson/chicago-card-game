...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
	...
	<div class="pt-12 pb-8 text-center">
		<div class="mx-auto max-w-4xl px-4">
			<h1 class="mb-4 text-5xl font-bold text-gray-900">Chicago: Race to 52 Points</h1>
			<p class="mx-auto mb-6 max-w-2xl text-xl text-gray-600">
				A Swedish card game for 2-4 players. Score points with poker hands and be the first to reach
				52 points to win!
			</p>
			...
			<div class="lg:col-span-1">
				<div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg">
					<div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
						...
						<p class="mt-1 text-sm text-blue-100">Add players to begin a new Chicago game</p>
					</div>
					...
					<div class="p-6">
						...
						{#if players.length === 0}
							<div class="mt-6 rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 p-4">
								<div class="text-center">
									...
									<p class="text-sm font-medium text-gray-600">No players added yet</p>
									<p class="mt-1 text-xs text-gray-500">Add 2-4 players to start playing</p>
								</div>
							</div>
						{/if}
					</div>
