...
{#if games.length > 0}
	<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
		<div class="px-4 py-3 bg-gray-50 border-b border-gray-200">
			<h3 class="text-lg font-semibold text-gray-900">Previous Games</h3>
			<p class="text-sm text-gray-600">{games.length} game{games.length === 1 ? '' : 's'} found</p>
		</div>
...
{:else}
	<div class="text-center py-8 text-gray-500">
		...
		<p class="text-lg font-medium mb-2">No previous games found</p>
		<p class="text-sm">Start a new game to see it listed here</p>
	</div>
{/if}
